...
var time = new Date().toLocaleString('es-ES', {timeZone: timezone});
let hourArray = time.split(' ');
let hour = Number(hourArray[1].slice(0,2));
let day = new Date().getDay();
if(hour >= inicio && hour < fin && day > 0 && day < 6){
    ...
    if(body){
        ...
        var textH3 = document.createTextNode('¿Tienes una pregunta? ¡Escríbenos!');
        ...
        var textButtonSubmit = document.createTextNode('Si, tengo una pregunta');
    ...
    // We pre-filled your app ID in the widget URL: 'https://widget.intercom.io/widget/aplmev5h'
    (function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',w.intercomSettings);}else{var d=document;var i=function(){i.c(arguments);};i.q=[];i.c=function(args){i.q.push(args);};w.Intercom=i;var l=function(){var s=d.createElement('script');s.type='text/javascript';s.async=false;s.src='https://widget.intercom.io/widget/aplmev5h';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);};if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();
}
